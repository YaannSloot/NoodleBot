...
public class SettingsCommand extends Command {
	...
	public boolean CheckForCommandMatch(IMessage command) {
		return command.getContent().toLowerCase().startsWith(BotUtils.BOT_PREFIX + "set ");
	}
	...
	public void execute(MessageReceivedEvent event) throws NoMatchException {
		...
		String command = BotUtils.normalizeSentence(
				event.getMessage().getContent().toLowerCase().substring((BotUtils.BOT_PREFIX + "set").length()));
