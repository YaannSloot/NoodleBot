...
public class SkipCommand extends Command {
	...
	public boolean CheckForCommandMatch(Message command) {
		return command.getContentRaw().toLowerCase().equals(BotUtils.BOT_PREFIX + "skip");
	}
	...
	public String getHelpSnippet() {
		return "**" + BotUtils.BOT_PREFIX + "skip** - Skips the currently playing track _(" + BotUtils.BOT_PREFIX
				+ "help " + getCommandId() + ")_";
	}
