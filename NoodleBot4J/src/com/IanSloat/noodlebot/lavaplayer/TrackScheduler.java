package com.IanSloat.noodlebot.lavaplayer;
...
// TODO This isn't finished. Work on it when the player command gets created
public class TrackScheduler extends AudioEventAdapter {
	...
	/**
	 * Sets the current channel to output status messages to
	 * 
	 * @param channel The channel to output status messages to
	 */
	 ...
	 * 
	 * @return The current TextChannel that the output is being sent to
	 */
